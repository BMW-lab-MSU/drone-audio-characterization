...
folds_path = r"/home/c56r747/drone_audio_characterization/splits_manual_20ms"
...
for test_fold in range(10):
    ...
    for fold_idx in range(10):
        ...
        X = np.load(os.path.join(fold_dir, f"man_20_fold_{fold_idx}.npy"))
...
excel_filename = "results_manual_20.xlsx"
